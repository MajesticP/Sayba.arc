      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-10 mb-6 md:mb-12">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <p className="text-sm leading-relaxed mb-2 max-w-sm">Art You Believe — Agensi Digital & Engineering dari Pontianak</p>
            <p className="text-xs text-white/25">{siteConfig.address}</p>

            {/* Generic capability pills */}
            <div className="flex flex-wrap gap-2 mt-5">
              <span className="text-[10px] md:text-xs px-2 md:px-3 py-0.5 md:py-1 rounded-full border border-[#ff914d]/30 text-[#ff914d]/70">Digital & Engineering</span>
              <span className="text-[10px] md:text-xs px-2 md:px-3 py-0.5 md:py-1 rounded-full border border-white/10 text-white/30">Solusi Teknis</span>
            </div>
          </div>
        ...
        <div className="border-t border-white/8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-white/20">
          <span>© {new Date().getFullYear()} {siteConfig.name}. Hak cipta dilindungi.</span>
          <span>Kecerdasan Digital & Rekayasa Teknis · Pontianak, Indonesia</span>
        </div>
      </div>
    </footer>
  )
