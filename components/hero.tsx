          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-14 items-center">
              ...
              <div className="space-y-4 md:space-y-7">
                {data.badge && (
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/8 border border-white/15 text-xs font-medium text-white/60">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#ff914d] animate-pulse" />
                    {data.badge}
                  </div>
                )}

                <h1 className="text-2xl sm:text-4xl lg:text-6xl font-bold text-white leading-[1.1] tracking-tight">
                  {data.title}
                </h1>

                <p className="text-white/55 text-sm md:text-lg leading-relaxed max-w-xl">
                  {data.subtitle}
                </p>

                {/* Department badges */}
                <div className="flex flex-wrap gap-2 pt-0.5">
                  <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-[#ff914d]/15 border border-[#ff914d]/30">
                  ...
                  <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-white/8 border border-white/15">
                ...
                <div className="flex flex-col sm:flex-row gap-2 pt-0.5">
                  <Link
                    ...
                    className="px-6 py-2.5 md:py-3 rounded-xl font-semibold bg-[#ff914d] text-white hover:bg-[#e07b3a] transition-all duration-200 hover:shadow-xl hover:shadow-orange-500/25 hover:scale-105 text-center text-sm"
                  >
                    {data.primaryButton.text}
                  </Link>
                  <Link
                    href={data.secondaryButton.href}
                    className="px-6 py-2.5 md:py-3 rounded-xl font-semibold bg-white/8 text-white border border-white/15 hover:bg-white/12 transition-all duration-200 hover:scale-105 text-center text-sm"
                  >
