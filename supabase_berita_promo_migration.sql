...
-- (konvensi yang sama dengan tabel portfolio/layanan/informasi).
...
select * from (values
  ...
  ('/promo/promo-3-1600x600.png', 'Promo pusat informasi & dokumen teknis SAYBA ARC', 'Pusat Informasi',
   'Informasi & Dokumen Teknis',
   'Panduan, standar, dan pengumuman layanan yang bisa diakses kapan saja.',
   'Lihat Informasi', '/informasi', 3, 'active')
