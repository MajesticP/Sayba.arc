...
export default function ContactPage() {
  return (
    <main className="board-area min-h-screen flex flex-col">
      ...
      <BoardSection id="kontak" panelClassName="panel-top-pad">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
              ...
              <div className="space-y-2.5 md:space-y-5">
                ...
                <div className="p-4 md:p-6 bg-navy rounded-2xl relative overflow-hidden">
                  ...
                  <p className="text-orange-soft text-[12.5px] md:text-sm leading-relaxed pl-3">
              ...
              {/* WhatsApp CTA */}
              <div className="bg-ice-dim rounded-2xl p-6 md:p-10 border border-ice-line flex flex-col items-center justify-center text-center gap-4">
                <div className="w-14 h-14 rounded-full bg-[#0d6b38]/12 flex items-center justify-center">
                  <svg viewBox="0 0 24 24" fill="#0d6b38" className="w-7 h-7" aria-hidden="true">
                ...
                <a
                  ...
                  className="btn-solid w-full !bg-[#0d6b38] !text-white hover:!bg-[#0a5c30]"
                >
