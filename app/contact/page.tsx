      ...
      <section className="bg-black py-20">
        <PageTransition>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span className="inline-block text-xs font-bold text-[#ff914d] uppercase tracking-widest mb-4">Ayo Bicara</span>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">{contactPage.title}</h1>
            <p className="text-white/45 text-lg max-w-xl mx-auto">{contactPage.subtitle}</p>
          </div>
        </PageTransition>
      </section>
        ...
        <PageTransition delay={100}>
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="space-y-5">
                ...
                {contactPage.info.map((item, index) => (
                  <a
                    key={index}
                    href={item.href}
                    className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-black/8 hover:border-[#ff914d]/30 hover:shadow-lg hover:shadow-orange-50 transition-all duration-300 group"
                  >
                    <div className="w-11 h-11 rounded-xl bg-[#ff914d]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#ff914d]/20 transition-colors">
                      <DynamicIcon name={item.icon} color="#ff914d" size={22} />
                    </div>
                    <div>
                ...
                <div className="mt-8 p-6 bg-black rounded-2xl relative overflow-hidden">
              ...
              {/* Form */}
              <div className="bg-[#f7f7f7] rounded-2xl p-8 border border-black/5">
