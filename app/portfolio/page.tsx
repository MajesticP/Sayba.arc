      ...
      <section className="bg-black py-20">
        <PageTransition>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span className="inline-block text-xs font-bold text-[#ff914d] uppercase tracking-widest mb-4">Karya Kami</span>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Portofolio</h1>
            <p className="text-white/45 text-lg max-w-xl mx-auto">Proyek-proyek pilihan dari Departemen ArcGIS dan Departemen IT kami.</p>
          </div>
        </PageTransition>
      </section>
                ...
                {items.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`group rounded-2xl border transition-all duration-300 hover:-translate-y-1 hover:shadow-xl cursor-pointer relative overflow-hidden flex flex-col ${
                        isArcgis
                    ...
                    >
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        <h3 className="text-lg font-bold text-black mb-2 leading-snug">{item.title}</h3>
                        {item.description && (
                          <p className="text-black/50 text-sm leading-relaxed flex-1 line-clamp-3">{item.description}</p>
                        )}
                        <div className={`mt-4 flex items-center gap-1 text-xs font-semibold transition-colors duration-200 ${
